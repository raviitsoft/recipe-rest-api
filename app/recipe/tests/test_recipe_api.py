...
def sample_tag(user, name='main ravi'):
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_retrieve_recipe(self):
        """test retrieveing a list of recipe"""
    ...
    def test_create_recipe_with_ingredients(self):
        """creating a recipe with ingredient"""
        ...
        payload = {
            'title': 'avacoda line ches witn ingredient',
